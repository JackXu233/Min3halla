...
public class MHMenuTypes {
    ...
    public static final RegistryObject<MenuType<BTCFillinfMachineMenu>> BTC_FILLING_MACHINE_MENU =
            MENU_TYPES.register("btc_filling_machine_menu",
                    () -> IForgeMenuType.create((windowId, inv, data) -> new BTCFillinfMachineMenu(windowId, inv)));
}
